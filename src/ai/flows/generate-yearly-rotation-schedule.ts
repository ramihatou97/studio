...
**Objective:**
Your primary goal is to create a schedule that maximizes the number of neurosurgery residents on the primary 'Neurosurgery' service at all times, while respecting all constraints.
...
**Instructions:**
1.  Analyze the residents and their mandatory off-service rotations.
